# Support for Output Descriptors in Shieldcoin Core

Since Shieldcoin Core v0.17, there is support for Output Descriptors in the
...
on Shieldcoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Shieldcoin Core wallets, a convenience function `combo` is
