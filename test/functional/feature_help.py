...
"""Verify that starting shieldcoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start shieldcoin with -h for help text")
        ...
        self.log.info("Start shieldcoin with -version for version information")
        ...
        self.log.info("Start shieldcoind with -fakearg to make sure it does not start")
