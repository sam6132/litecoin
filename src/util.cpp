...
const char * const BITCOIN_CONF_FILENAME = "shieldcoin.conf";
const char * const BITCOIN_PID_FILENAME = "shieldcoin.pid";
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Shieldcoin";
#else
    // Unix
