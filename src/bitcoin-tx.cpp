...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " shieldcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  shieldcoin-tx [options] <hex-tx> [commands]  Update hex-encoded shieldcoin transaction\n" +
            "or:     shieldcoin-tx [options] -create [commands]   Create hex-encoded shieldcoin transaction\n" +
            "\n";
