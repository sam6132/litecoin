...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed-a.shieldcoin.loshan.co.uk");
        vSeeds.emplace_back("dnsseed.thrasher.io");
        vSeeds.emplace_back("dnsseed.shieldcointools.com");
        vSeeds.emplace_back("dnsseed.shieldcoinpool.org");
...
public:
	...
	genesis = CreateGenesisBlock(1513784917, 2084820399, 0x1e0ffff0, 1, 50 * COIN);
        ...
        vSeeds.emplace_back("testnet-seed.shieldcointools.com");
        vSeeds.emplace_back("seed-b.shieldcoin.loshan.co.uk");
